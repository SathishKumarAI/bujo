...
| BUJO-281b | Move Mood analytics (best/worst day, weekday vs weekend, stability), Habit analytics (mood impact, consistency, month over month) and Lifetime (year in review, index, personal records) onto Stats — **merged into Stats' existing folds, not added as new ones.** Stats already has six; relocating three more drawers unchanged would make it a nine-drawer cabinet and move the problem rather than fix it | 🔜 |
