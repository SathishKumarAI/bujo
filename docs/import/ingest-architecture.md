...
| 5 | `feat/apple-health-adapter` | `File → AsyncIterable<ImportRecord>`, streaming, behind the same preview. Depends on `apple-health-research.md` | A real export imports; re-importing it reports all-no-ops; counts match the preview |
