...
const RULES: { match: string[]; info: ExerciseInfo }[] = [
  ...
  { match: ['bench', 'chest press', 'pec', 'fly', 'push up', 'push-up', 'dips'], info: { cue: 'Retract shoulder blades, slight arch, elbows ~45° from the torso.', watch: 'Don’t flare elbows to 90° or bounce off the chest — protects the shoulder.' } },
