...
export const VIEW_CHROME: Record<ViewId, ViewChrome> = {
  ...
  gym: { title: 'Gym', subtitle: 'Sessions & exercises', help: 'Structured strength logging: searchable exercise picker, per-set weight/reps/RPE/type, 1RM hints, the 12-week program tracker, training-volume charts, plate calculator, muscle map with form/injury cues, and progress photos.' },
