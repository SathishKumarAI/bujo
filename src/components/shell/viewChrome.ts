...
export const VIEW_CHROME: Record<ViewId, ViewChrome> = {
  ...
  'kitchen-sink': { title: 'Kitchen sink', subtitle: 'Every primitive, variant and state', help: 'A design-system review page: the type scale, foreground tiers, surfaces, every button variant and size, inputs, data displays and container tiers, all on one screen. Not linked from the sidebar — reach it with ?view=kitchen-sink.' },
