  ...
  return (
    <div className={className}>
      {value ? (
        <div className="group relative overflow-hidden rounded-card border border-line">
          ...
          <div className="absolute top-2 right-2 flex gap-1 opacity-0 transition-opacity group-hover:opacity-100">
            <button
              ...
              title="Replace photo"
              className="inline-flex items-center gap-1 rounded-pill bg-crust/85 px-2.5 py-1 text-label text-fg-1 hover:text-mauve"
            >
            ...
            <button
              ...
              title="Remove photo"
              className="grid h-7 w-7 place-items-center rounded-pill bg-crust/85 text-fg-1 hover:text-red"
            >
              <Icon as={X} size="sm" />
            </button>
          </div>
        ...
        <Button variant="secondary" onClick={() => ref.current?.click()} className="press-3d rounded-control flex w-full items-center justify-center gap-2">
