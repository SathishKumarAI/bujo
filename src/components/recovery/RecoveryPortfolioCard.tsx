...
export function RecoveryPortfolioCard({ portfolio }: { portfolio: Portfolio }) {
  return (
    <Card hideInfo title={<span className="inline-flex items-center gap-2"><Icon as={ListNumbers} size="md" className="text-mauve" /> Recovery portfolio</span>} subtitle="Every streak you’re holding, ranked by current run">
