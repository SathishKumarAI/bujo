...
export function SelfEfficacyCard({ conversion }: { conversion: Conversion }) {
  return (
    <Card band hideInfo title="Self-efficacy" subtitle={`${conversion.resistRate}% of urge moments ended in a win, not a reset`}>
      ...
      <div className="mt-3 h-2.5 overflow-hidden rounded-none" style={{ background: cat('red') + '33' }}>
        <div className="h-full rounded-none transition-[width] duration-500" style={{ width: `${conversion.resistRate}%`, background: cat('green') }} />
      </div>
