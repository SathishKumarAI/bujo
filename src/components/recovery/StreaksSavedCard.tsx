...
export function StreaksSavedCard({ saved }: { saved: Saved }) {
  return (
    <Card title={<span className="inline-flex items-center gap-2"><Icon as={ShieldCheck} size="md" className="text-green" /> Streaks you saved</span>} subtitle="Every resisted urge was a reset that didn’t happen" help="Each urge you surfed was a moment that could have become a reset. Counting them reframes resistance as progress protected — not just willpower spent, but streaks kept alive.">
