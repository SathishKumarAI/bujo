    ...
    return (
      <Hero>
        <div className="flex items-center gap-3">
          <div className="grid h-12 w-12 place-items-center rounded-pill bg-secondary">
        ...
        {isGuest && <p className="mt-4 rounded-control bg-secondary/50 p-3 text-label text-fg-2">Exploring as a guest. Sign out, then create an account to keep your data safe and synced.</p>}
  ...
  return (
    <div className="aurora grid min-h-[calc(100vh-9rem)] place-items-center px-4 py-8">
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="card-3d rise rounded-card border border-line bg-card/80 p-6 backdrop-blur" style={{ animationDelay: '140ms' }}>
          {children}
        </div>
...
function Field({ icon: Icon, children }: { icon: typeof Envelope; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2.5 rounded-control border border-input bg-background px-3 py-2.5 focus-within:border-primary">
