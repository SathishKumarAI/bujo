      ...
      <PageLayout
        ...
        >
          ...
          >
            ...
            {nextBenefit && <p className="mt-2 inline-flex items-center gap-1.5 rounded-card bg-peach/10 p-2 text-label text-fg-2"><Icon as={Warning} size="sm" className="text-peach" /> You’re {stats.daysToNext} day{stats.daysToNext === 1 ? '' : 's'} from {nextBenefit.label}. Don’t trade weeks of progress for 10 minutes.</p>}
          </RefBlock>
